...
//
/**
 * <h3>Vorgaben f&uuml;r die Klasse Person.</h3> Diese Klasse
 * <code>Mensch</code> gibt als abstrakte Klasse Funktionen der Klasse
 * <code>Person</code> vor.
 * 
 * @version 0003 Samstag 03.05.2014 09:56:53
 * @author Dr. Gerd Wegener
 */
public abstract class Mensch01 {
	/**
	 * <h4>Familienname.</h4>
	 * 
	 * @return Familienname
	...
	public String getGeburtsDatum() {
		return Helfer01.textDatum(getGeburtsTag(), getGeburtsMonat(),
				getGeburtsJahr());
	}
	...
	public String getTodesDatum() {
		return Helfer01.textDatum(getTodesTag(), getTodesMonat(), getTodesJahr());
	}
	 ...
	 * <h4>Verstorben.</h4>
	 * 
	 * @return <code>true</code>, wenn die Person verstorben ist,
	 ...
	 * 
	 * @return Sterbealter, wenn die Person verstorben ist, Alter heute, sonst,
	 ...
	 * <h4>Anrede.</h4>
	 * 
	 * @return korrekte Anrede in Briefen
	 *         ("Sehr geehrter Herr Titel Vorsatz Zusatz Name," bzw.
	 *         "Sehr geehrte Frau Titel Vorsatz Zusatz Name,") Beim Titel werden
	 *         Dr. und Prof. ausgeschrieben, sind im Vorsatz "herr" oder "frau"
	 *         bereits enthalten, f&auml;llt das "Herr" und "Frau" weg.
	 */
