...
SET @p0='Robert Allen'; SET @p1='Zimmerman'; SET @p2=''; SET @p3=''; SET @p4=''; SET @p5='m'; SET @p6='j'; SET @p7=''; SET @p8=''; SET @p9=''; SET @p10=''; SET @p11=''; SET @p12=''; SET @p13='Bob Dylan'; SET @p14='Gitarre, Mundharmonika, Orgel und Klavier'; SET @p15='Blowing In The Wind'; SET @p16='https://www.youtube.com/watch?v=vWwgrjjIMXA'; SET @p17=''; SET @p18=''; SET @p19=''; SET @p20=''; CALL `musikerErstellen`(@p0, @p1, @p2, @p3, @p4, @p5, @p6, @p7, @p8, @p9, @p10, @p11, @p12, @p13, @p14, @p15, @p16, @p17, @p18, @p19, @p20);
