...
SET @p0='Robert Alan'; SET @p1='Krieger'; SET @p2=''; SET @p3=''; SET @p4=''; SET @p5='m'; SET @p6=''; SET @p7='08'; SET @p8='01'; SET @p9='1946'; SET @p10=''; SET @p11=''; SET @p12=''; SET @p13='Robby Krieger'; SET @p14='Gitarre'; SET @p15=''; SET @p16='http://de.wikipedia.org/wiki/Robby_Krieger'; SET @p17=''; SET @p18=''; SET @p19=''; SET @p20=''; CALL `musikerErstellen`(@p0, @p1, @p2, @p3, @p4, @p5, @p6, @p7, @p8, @p9, @p10, @p11, @p12, @p13, @p14, @p15, @p16, @p17, @p18, @p19, @p20);

SET @p0='Raymond Daniel'; SET @p1='Manzarek'; SET @p2=''; SET @p3=''; SET @p4=''; SET @p5='m'; SET @p6=''; SET @p7='12'; SET @p8='02'; SET @p9='1939'; SET @p10='20'; SET @p11='05'; SET @p12='2013'; SET @p13='Ray Manzarek'; SET @p14='Elektronische Orgel'; SET @p15=''; SET @p16='http://de.wikipedia.org/wiki/Ray_Manzarek'; SET @p17=''; SET @p18=''; SET @p19=''; SET @p20=''; CALL `musikerErstellen`(@p0, @p1, @p2, @p3, @p4, @p5, @p6, @p7, @p8, @p9, @p10, @p11, @p12, @p13, @p14, @p15, @p16, @p17, @p18, @p19, @p20);
