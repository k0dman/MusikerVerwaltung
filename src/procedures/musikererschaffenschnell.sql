...
SET @p0='Guns N’ Roses'; SET @p1=''; SET @p2=''; SET @p3='Paradise City'; SET @p4='http://de.wikipedia.org/wiki/Guns_N%E2%80%99_Roses'; SET @p5='12'; SET @p6=''; SET @p7='j'; CALL `gruppeErstellen`(@p0, @p1, @p2, @p3, @p4, @p5, @p6, @p7);
